            ...
            <div className="legal-section-container container">
                <div className="legal-section">
                    ...
                    <p>5.9 We may, but shall not be obliged to, keep Your Files after your account has been suspended or terminated. In particular, we may, but shall not be obliged to, keep Your Files where we consider it necessary for evidential purposes relating
                        to a breach of our <a href="https://mega.nz/terms">ToS</a> or with respect to current or anticipated action by any competent enforcement authority or other third party. With respect to release of Your Files to competent enforcement
                    ...
                    <p>6.4 From time to time we may need to communicate with each other directly. We will use the email address you have verified in your account. You can communicate with us using the appropriate address on our <a href="https://ente.io/contact">contacts page</a>.
                    ...
                    <p>7.1 We use a privacy focussed third-party analytics service to monitor the metrics of our website. You can read their privacy policy here: <a href="https://simpleanalytics.com/privacy">https://simpleanalytics.com/privacy</a></p>
                    ...
                    <ul>
                        <li>Apple: <a href="https://www.apple.com/legal/privacy/">https://www.apple.com/legal/privacy</a></li>
                        <li>Google: <a href="https://policies.google.com/privacy">https://policies.google.com/privacy</a></li>
                        <li>Stripe: <a href="https://stripe.com/privacy">https://stripe.com/privacy</a></li>
                    </ul>
                    <p>13.2. <strong>Support Chat</strong></p>
                    <p>We use Crisp to power our support chat interface. You can find their privacy policy here: <a href="https://crisp.chat/privacy">https://crisp.chat/privacy</a>.</p>
                    <p>13.3. <strong>Feedback Collection</strong></p>
                    <p>We use FeatureMonkey to collect feedback from users and to decide what features we should be working on. You can find their privacy policy here: <a href="https://www.featuremonkey.com/privacy/">https://www.featuremonkey.com/privacy</a>.</p>
                    <p>13.4. <strong>Website Analytics</strong></p>
                    <p>We use a privacy focused third-party analytics service to monitor the metrics of our website. You can read their privacy policy here: <a href="https://simpleanalytics.com/privacy">https://simpleanalytics.com/privacy</a></p>
                    <p>13.5. <strong>Backend Analytics</strong></p>
                    <p>We use Amplitude for analyzing API access patterns. The data that is pushed to them is obfuscated and does not include a user's personal information (like name or email). You can read their privacy policy here: <a href="https://amplitude.com/privacy">https://amplitude.com/privacy</a>.
                    </p>
                    <p>13.6. <strong>Transactional Emails</strong></p>
                    <p>We use Zoho for sending out emails like login tokens, billing reminders, notification when an album is shared with you, etc. You can read their privacy policy here: <a href="https://zoho.com/privacy">https://zoho.com/privacy</a>.
                    </p>
                    ...
                    <ol start="16">
                        <li>Data security is very important to ente, whether that is your personal information or any other data. That is why we publish our client-side browser and mobile app software and why we have provided information in this Policy on collection
                            and storage of all data whether or not it is personal information. For more information on our security practices, see our <a href="https://ente.io/blog">blog</a>.</li>
                    </ol>
                    ...
                    <ol start="22">
                        <li>
                            <p>Questions and comments regarding this Policy are welcomed and should be addressed to the Privacy Officer at privacy@ente.io. For a comprehensive list of contact details for Drizzle Technologies Private Limited, and each of our
                                related or affiliated entities and payment processors, together with details of how to contact our privacy officer and data protection officer, see our <a href="https://ente.io/contact">contacts</a> page.</p>
                        </li>
                        <li>
                            <p>If you are in Europe or otherwise have the right to lodge a complaint with a supervisory authority, you can find contact details for our European Representative and European supervisory authority on our <a href="https://ente.io/contact">contacts</a>                            page.</p>
                        </li>
                    </ol>
